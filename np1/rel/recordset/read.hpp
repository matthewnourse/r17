...
public:
  ...
  void operator()(const rstd::string &reliable_storage_local_root,
    ...
    rstd::vector<rstd::string> args = rel::rlang::compiler::eval_to_strings_only(tokens);
  ...
  template <typename Input_Stream, typename Output_Stream>
  void do_read(const rstd::string &reliable_storage_local_root,
                const rstd::string &reliable_storage_remote_root,
                Input_Stream &input, Output_Stream &output,
                const rstd::string &source_recordset_name) {
    // Open the recordset.
    ...
    rstd::vector<rstd::string> chunk_ids;
    ...
    rstd::vector<rstd::string> heading_fields = headings.fields();
    ...
    rstd::vector<rstd::string> record_fields;
    ...
    rstd::vector<rstd::string>::const_iterator chunk_id_i = chunk_ids.begin();
    rstd::vector<rstd::string>::const_iterator chunk_id_iz = chunk_ids.end();
